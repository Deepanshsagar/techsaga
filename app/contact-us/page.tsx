...
/>
          ...
          <div className="bg-white shadow-2xl rounded-xl p-6 md:p-10 mb-10">
            ...
            <form className="mt-8 space-y-5">
              ...
              <div className="border border-gray-300 rounded-md p-4 text-gray-500 text-sm">
                Google reCAPTCHA Here
              </div>

              <button
                type="submit"
                className="bg-blue-600 hover:bg-blue-700 transition-all text-white px-8 py-3 rounded-lg font-semibold flex items-center gap-3"
              >
                Send Message
                <span>→</span>
              </button>
