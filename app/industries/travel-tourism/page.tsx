        ...
        <>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 before:content-[''] before:absolute before:w-[200px] before:h-[200px] before:bg-cover before:bg-center before:right-[0px] before:top-0 before:z-10 before:bg-[url('/assets/img/effect1.png')] before:bg-cover before:bg-center">
                    ...
                    <div className="fade-in">
                        ...
                        <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0b1535] leading-tight">
                            Engineering Seamless Journeys
                        </h2>

                        <p className="text-gray-400 mt-3 text-sm max-w-xl">
                            Modern travel ecosystems require scalable, secure, and intelligent digital infrastructures that elevate guest experiences and streamline booking operations.
                        </p>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#0b1535] mb-2">
                                            Booking Engines vs. Conversion Gaps
                                        </h4>

                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            We design tailor-made reservation systems and mobile concierge apps with intuitive filtering and instant confirmation to keep travelers engaged from the first click to the final check-out.
                                        </p>
                            ...
                            <div className="card-hover p-6 rounded-xl">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#0b1535] mb-2">
                                            Unified Guest Intelligence vs. Fragmented Data
                                        </h4>

                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            By syncing PMS (Property Management Systems), loyalty programs, and real-time availability into one powerhouse dashboard, we eliminate friction through a secure, single source of travel truth.
                                        </p>
                            ...
                            <div className="card-hover ps-0 p-6 rounded-xl">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#0b1535] mb-2">
                                            Infinite Scalability vs. Booking Surges
                                        </h4>

                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            Using elastic cloud architectures, we build platforms designed to handle massive seasonal spikes and flash-sale traffic, ensuring that your inventory and checkout remain available 24/7 without latency.
                                        </p>
                            ...
                            <div className="card-hover p-6 rounded-xl">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#0b1535] mb-2">
                                            Security by Design vs. Travel Data Vulnerability
                                        </h4>

                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            We implement enterprise-grade encryption and PCI-DSS compliant payment processing for every itinerary, transforming your platform into a digital vault that protects sensitive traveler profiles and maintains total global trust.
                                        </p>
            ...
            <section className="mt-10 px-4 mb-20">
                ...
                <p className="text-gray-500 text-sm leading-relaxed text-center mb-14">
                    Turn every search into a departure with high-velocity tourism engines built to scale.
                </p>
