...
export async function generateMetadata() {
  return getMeta("/industries/logistics-and-transportation");
}
const Industries = () => {
    return (
        <>
            ...
            <section
                ...
                style={{
                    backgroundImage: "url('/assets/img/industries-page/Logistics-Transportation.webp')",
                }}
            >
                    ...
                    <div className="grid lg:grid-cols-2 items-center gap-12">
                        ...
                        <div>
                            ...
                            <h1 className="text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">
                                ...
                                <div className="text-3xl lg:text-4xl mt-2">Precision in Motion</div>
                            </h1>

                            <p className="text-white text-base leading-relaxed mb-8">
                                In an interconnected global economy, your logistics infrastructure must be as agile as the markets you serve. We build intelligent, visibility-driven ecosystems that bridge the gap between supply chain complexity and seamless, real-time fulfillment.
                            </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 before:content-[''] before:absolute before:w-[200px] before:h-[200px] before:bg-cover before:bg-center before:right-[0px] before:top-0 before:z-10 before:bg-[url('/assets/img/effect1.png')] before:bg-cover before:bg-center">
                    ...
                    <div className="fade-in">
                        ...
                        <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0b1535] leading-tight">
                            Engineering Distribution Excellence
                        </h2>

                        <p className="text-gray-400 mt-3 text-sm max-w-xl">
                            Modern logistics ecosystems require scalable, secure, and intelligent digital infrastructures that streamline fulfillment operations and optimize supply chain performance.
                        </p>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#0b1535] mb-2">
                                            Personalized Fleet Intelligence vs. Visibility Gaps
                                        </h4>

                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            We design tailor-made telematics interfaces and mobile driver apps with real-time GPS tracking and route optimization to keep your fleet moving efficiently and reduce transit times.
                                        </p>
                            ...
                            <div className="card-hover p-6 rounded-xl">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#0b1535] mb-2">
                                            Unified Inventory Intelligence vs. Fragmented Warehousing
                                        </h4>

                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            By syncing WMS (Warehouse Management Systems), IoT sensor data, and order history into one powerhouse dashboard, we eliminate stock-outs and overages through a secure, single source of logistics truth.
                                        </p>
                            ...
                            <div className="card-hover ps-0 p-6 rounded-xl">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#0b1535] mb-2">
                                            Infinite Scalability vs. Seasonal Surges
                                        </h4>

                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            Using elastic cloud architectures, we build platforms designed to handle massive spikes in order volume during peak seasons, ensuring that processing and dispatch remain available 24/7 without bottlenecks.
                                        </p>
                            ...
                            <div className="card-hover p-6 rounded-xl">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#0b1535] mb-2">
                                            Security by Design vs. Chain-of-Custody Risks
                                        </h4>

                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            We implement enterprise-grade encryption and automated documentation logs to protect sensitive cargo data and customs information, transforming your platform into a digital vault that maintains total regulatory compliance.
                                        </p>
