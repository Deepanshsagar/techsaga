...
export async function generateMetadata() {
  return getMeta("/industries/government");
}
const Industries = () => {
    return (
        <>
            ...
            <section
                ...
                style={{
                    backgroundImage: "url('/assets/img/industries-page/Government.webp')",
                }}
            >
                    ...
                    <div className="grid lg:grid-cols-2 items-center gap-12">
                        ...
                        <div>
                            ...
                            <h1 className="text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">
                               ...
                               <div className="text-3xl lg:text-4xl mt-2"> Precision in Public Service</div>
                            </h1>

                            <p className="text-white text-base leading-relaxed mb-8">
                                In an era of increasing digital expectations, civic platforms must be as dependable as the institutions they represent. We build secure, citizen-centric ecosystems that bridge the gap between administrative complexity and seamless public service delivery.
                            </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 before:content-[''] before:absolute before:w-[200px] before:h-[200px] before:bg-cover before:bg-center before:right-[0px] before:top-0 before:z-10 before:bg-[url('/assets/img/effect1.png')] before:bg-cover before:bg-center">
                    ...
                    <div className="fade-in">
                        ...
                        <p className="text-gray-400 mt-3 text-sm max-w-xl">
                            Modern public service ecosystems require scalable, secure, and intelligent digital infrastructures that streamline citizen engagement and improve governance efficiency.
                        </p>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#0b1535] mb-2">
                                            Citizen Portals vs. Bureaucratic Gaps
                                        </h4>

                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            We design tailor-made e-governance platforms and mobile apps with intuitive permit filing and real-time status tracking to keep citizens informed and engaged with public services.
                                        </p>
                            ...
                            <div className="card-hover p-6 rounded-xl">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#0b1535] mb-2">
                                            Unified Departmental Intelligence vs. Agency Silos
                                        </h4>

                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            By syncing cross-departmental databases and public records into one powerhouse dashboard, we eliminate information bottlenecks through a secure, single source of governmental truth.
                                        </p>
                            ...
                            <div className="card-hover ps-0 p-6 rounded-xl">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#0b1535] mb-2">
                                            Infinite Scalability vs. Service Downtime
                                        </h4>

                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            Using sovereign cloud architectures, we build platforms designed to handle massive traffic during tax seasons or public filings, ensuring that critical civic resources remain available 24/7 without interruption.
                                        </p>
                            ...
                            <div className="card-hover p-6 rounded-xl">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#0b1535] mb-2">
                                            Security by Design vs. National Data Vulnerability
                                        </h4>

                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            We implement military-grade encryption and multi-factor authentication for every digital identity, transforming your platform into a digital vault that protects sensitive citizen data and maintains total public trust.
                                        </p>
            ...
            <section className="mt-10 px-4 mb-20">
                ...
                <p className="text-gray-500 text-sm leading-relaxed text-center mb-14">
                    Turn every civic interaction into a more efficient outcome with high-velocity government engines built to scale.
                </p>
