        ...
        <>
                    ...
                    <div className="grid lg:grid-cols-2 items-center gap-12">
                        ...
                        <div>
                            ...
                            <h1 className="text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">
                                ...
                                <div className="text-3xl lg:text-4xl mt-2">Precision in Pedagogy</div>
                            </h1>

                            <p className="text-white text-base leading-relaxed mb-8">
                                In a digital-first learning landscape, your educational platform must be as engaging as the curriculum you deliver. We build secure, learner-centric ecosystems that bridge the gap between academic complexity and seamless, intuitive user experiences.
                            </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 before:content-[''] before:absolute before:w-[200px] before:h-[200px] before:bg-cover before:bg-center before:right-[0px] before:top-0 before:z-10 before:bg-[url('/assets/img/effect1.png')] before:bg-cover before:bg-center">
                    ...
                    <div className="fade-in">
                        ...
                        <p className="text-gray-400 mt-3 text-sm max-w-xl">
                            Modern education platforms demand scalable, secure, and engaging digital ecosystems that enhance learning outcomes and simplify academic operations.
                        </p>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#0b1535] mb-2">
                                            Customized Learning Portals vs. Engagement Gaps
                                        </h4>

                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            We design tailor-made LMS and mobile applications with interactive course modules and progress tracking to keep students motivated and aligned with their learning objectives.
                                        </p>
                            ...
                            <div className="card-hover p-6 rounded-xl">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#0b1535] mb-2">
                                            Unified Student Records vs. Information Silos
                                        </h4>

                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            By syncing SIS (Student Information Systems) and assessment data into one powerhouse dashboard, we eliminate administrative gaps through a secure, single source of academic truth.
                                        </p>
                            ...
                            <div className="card-hover ps-0 p-6 rounded-xl">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#0b1535] mb-2">
                                            Infinite Scalability vs. Platform Downtime
                                        </h4>

                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            Using robust cloud architectures, we build platforms that handle peak enrollment periods and high-concurrency exam loads, ensuring that learning resources are available 24/7 without fail.
                                        </p>
                            ...
                            <div className="card-hover p-6 rounded-xl">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold text-[#0b1535] mb-2">
                                            Security by Design vs. Intellectual Property Risks
                                        </h4>

                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            We implement enterprise-grade encryption and secure access controls to protect sensitive student data and proprietary content, transforming your platform into a digital vault that maintains total institutional trust.
                                        </p>
            ...
            <section className="mt-10 px-4 mb-20">
                ...
                <p className="text-gray-500 text-sm leading-relaxed text-center mb-14">
                    Turn every digital interaction into a better learning outcome with rapid educational engines built to scale.
                </p>
