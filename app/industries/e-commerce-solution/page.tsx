    ...
    return (
        <>
            ...
            <section
                ...
                style={{
                    backgroundImage: "url('/assets/img/industries-page/E-Commerce.webp')",
                }}
            >
                    ...
                    <div className="grid lg:grid-cols-2 items-center gap-12">
                        <div>
                            <h1 className="text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">
                                E-Commerce
                                <div className="text-3xl lg:text-4xl mt-2">Reimagining the Digital Storefront</div>
                            </h1>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2">
                            ...
                            <div className="card-hover ps-0 p-6 rounded-xl">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-[#0b1535] mb-2">Infinite Flexibility vs. The Scalability Wall</h4>
                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            Using Headless Commerce and cloud-native architectures, we build platforms that breathe and expand with traffic spikes, ensuring zero crashes during your biggest sales.
                                        </p>
                                    </div>
                                </div>
                            </div>
