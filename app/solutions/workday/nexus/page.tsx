...
const services = [
  ...
  const highlights = [
    {
    title: "Global Architecture Velocity",
    description:
      "A structured 6-to-40-week roadmap engineered to match your international growth cadence.",
     },
    {
      title: "Frictionless Ecosystem Expansion",
      description:
        "Smooth multi-country rollouts and advanced module integration without disrupting active corporate hubs.",
    },
    {
      title: "Enterprise-Grade Support",
      description:
        "Hyper-care governance and localized support to maintain operational continuity during critical transitions.",
    },
    {
      title: "Scalable Risk Mitigation",
      description:
        "A repeatable, compliant framework built to standardize global operations while adapting to local regulatory nuances.",
    },
  ];
  const advantages = [
    {
      ...
      description:
        "Deep localization expertise ensures multi-country compliance with regional tax, labor, and privacy laws such as GDPR.",
    },
    {
      title: "Unified Global Architecture",
      description:
        "Standardizes multi-entity reporting while maintaining localized statutory requirements on a single Workday tenant.",
    },
    {
      title: "Phased Wave Rollouts",
      description:
        "Minimizes risk via structured multi-regional deployments designed around your corporate calendar.",
    },
  ];

 const deploymentScope = [
    "Multi-Currency & Multi-Entity Global Financials",
  "Advanced Compensation & Merit Planning",
  "Global Talent Acquisition & Recruitment Rollouts",
  "Workday Peakon Employee Voice (Global Surveys)",
  "Workday Learning & Strategic Succession Planning",
  "Custom Cross-Application Studio Integrations",
  ];
  ...
  const capabilities = [
    ...
    description:
      "Consolidated enterprise insights across countries, entities, and operational functions.",
  },
  {
    title: "Unified Modern Operations",
    description:
      "Centralized governance with localized execution for scalable international growth.",
  },
  {
    title: "Cross-Border Mobility",
    description:
      "Enable workforce movement and talent deployment across global regions efficiently.",
  },
  {
    title: "M&A Integration Frameworks",
    description:
      "Accelerate acquisition onboarding and business consolidation into a unified Workday environment.",
  },
  ];
...
export default function SparkPage() {
  return (
    <main className="font-sans text-gray-800 overflow-x-hidden">
      ...
      {/* HERO SECTION */}
      <section className="bg-[radial-gradient(#0000005c,#0033a6)]">
        <div className="max-w-7xl mx-auto px-6 pt-24 lg:pt-32 pb-0">
          ...
          <div className="max-w-5xl mx-auto text-center">
            <span className="inline-block px-4 py-1.5 text-sm font-semibold text-[#4291CE] bg-blue-100 rounded-full mb-4">
               Expand Your Workday Journey
            </span>

            <h1 className="text-4xl md:text-5xl text-white font-bold leading-tight mb-6">
              Effortlessly Extend Your Workday Footprint To Global Markets
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <span className="text-white font-semibold uppercase tracking-wider">
                What is Techsaga Nexus?
              </span>

              <p className=" text-lg text-white leading-relaxed mb-6 mt-4">
              Techsaga Nexus is a premier global expansion framework engineered for enterprise organizations 
              ready to take their Workday ecosystem further.
              </p>
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-3xl p-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                    Whether your business is breaking into new international territories or rolling out 
                    sophisticated, next-tier functional modules, Nexus provides a highly structured, 
                    predictable 6-to-40-week roadmap. Designed for complex corporate environments, this
                     deployment mechanism ensures friction-free scalability, strict cross-border compliance,
                     s and unified operational control across your entire global footprint.
                </p>
              </div>
            </div>
            <div>
       ...
       <section className="py-20 bg-gray-50">
         <div className="max-w-7xl mx-auto px-6">
           <h2 className="text-4xl font-bold text-center mb-16">
             Executive Highlights of Techsaga NEXUS
           </h2>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold mt-4">
              Advanced Functional Modules & International Expansion
            </h2>
          </div>
          ...
          <div className="">
              <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <h2 className="text-4xl font-bold mt-4 mb-6">
                    Global Intelligence & Unified Modern Operations
                </h2>
      ...
      <section className="py-24  text-white relative overflow-hidden pt-0 pb-5">
        ...
        <div className="max-w-7xl bg-blue-950 mx-auto px-6 text-center relative z-10 p-[70px] rounded-3xl ">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mt-6 mb-10">
              Take the Step Toward Smarter, Data-Driven Enterprise Operations
          </h2>
