    ...
    return (
        <main className="font-sans text-gray-800 overflow-x-hidden">
            ...
            <section
                ...
                style={{
                    backgroundImage: "url('/assets/img/solutions-page/Amazon-Web-Services.png')",
                }}
            >
                <div className="relative max-w-7xl mx-auto px-4 w-full">
                    <div className="grid lg:grid-cols-2 items-center gap-12">
                        <div>
                            <div>
                                <img
                                src="/assets/img/solutions-icon/AWS.png"
                                width={70}
                                height={70}
                            ...
                            <h1 className="text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">
                               AWS
                               <div className="lg:text-3xl text-3xl mt-2"> Architecting Your Future on the Cloud. </div>
                            </h1>
